...
그렇다면 왜 CAN 통신은 버스형 토폴로지를 사용할까요? 그건 바로 제어기의 확장과 관리가 용이하다는 점인데요.

![스크린샷 2024-02-18 오후 5.11.33](/images/$[filename]/스크린샷 2024-02-18 오후 5.11.33-8244482.png)
